...
export function Hero() {
  return (
    <section id="top" className="relative min-h-[100svh] w-full overflow-hidden">
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-6 md:px-10 min-h-[100svh] flex flex-col justify-center items-center text-center pt-28 pb-20">
        <div className="max-w-2xl mx-auto fade-in-up flex flex-col items-center">
          <p className="text-[11px] uppercase tracking-widest-3 text-foreground/70 mb-10">
            Maison de bien-être japonais
          </p>
          <img src={logo} alt="IBUKI" className="h-40 md:h-56 w-auto mb-6 breathe" />
          <p className="font-serif italic text-3xl md:text-4xl text-foreground/80 mb-12">
            Le souffle du bien-être japonais
          </p>
          <p className="text-[11px] uppercase tracking-widest-3 text-foreground/60 mb-10">
            Kobido <span className="mx-2 opacity-50">•</span> Shiatsu <span className="mx-2 opacity-50">•</span> Rituels japonais
          </p>
          <p className="font-serif text-2xl md:text-[28px] leading-relaxed text-foreground/90 max-w-xl mb-14">
            Chaque soin IBUKI est pensé comme un moment de calme,
            d'écoute et de présence — pour ralentir, relâcher
            et retrouver un équilibre intérieur.
          </p>
          <div className="flex flex-wrap items-center justify-center gap-5">
            <a
              href="#reservation"
              className="group inline-flex items-center gap-3 bg-foreground text-primary-foreground px-10 py-5 text-[11px] uppercase tracking-widest-3 shadow-[0_8px_30px_-12px_rgba(78,59,47,0.45)] hover:shadow-[0_14px_36px_-12px_rgba(78,59,47,0.55)] hover:-translate-y-0.5 transition-all duration-500"
            >
              Réserver un soin
